...
Refer to the companion [bibliography.bib](bibliography.bib) for LaTeX/BibTeX references.
...
Use this template to document every paper reviewed for AETHEL. Save individual reviews inside the appropriate directory in `literature/papers/` or append them below.
